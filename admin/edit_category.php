...
try {
    ...
    $error = "Database error: Unable to fetch category details.";
...
<head>
    ...
    <meta name="description" content="Admin panel to edit job categories">
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <form action="edit_category.php?id=<?php echo htmlspecialchars($category_id, ENT_QUOTES, 'UTF-8'); ?>" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="<?php echo htmlspecialchars($category['offshore_salary'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="onsite_salary"
                                name="onsite_salary"
                                value="<?php echo htmlspecialchars($category['onsite_salary'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            ><?php echo htmlspecialchars($category['perks'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            ><?php echo htmlspecialchars($category['onsite_perks'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                        </div>
                    </div>
                </div>
